...
public class OptionParser {
	 ...
	 *
	 * @see #parse(String[], CommandSender, boolean)
	 */
	public Map<Object, String[]> parse(String[] args, CommandSender sender) {
		return parse(args, sender, false);
	}
	 ...
	 * @return a map consists of the recognized command and their params
	 */
	public Map<Object, String[]> parse(String[] args, CommandSender sender, boolean multi) {
